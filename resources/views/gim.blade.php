...
<head>
  ...
  <style>
    * {
    ...
    .headerr {
      background: url('{{ asset('gim_hero.png') }}') no-repeat center center;
      background-size: cover;
      text-align: center;
      padding: 60px 20px;
      height: 611px;
    ...
    @media (max-width: 768px) {
      .headerr {
        background: url('{{ asset('gim_mb.png') }}') no-repeat center center;
        background-size: cover;
        height: auto;
  ...
  <section class="design-solution" style="width: 50%; margin: 0 auto; margin-bottom: 50px;">
    <div class="center" style="overflow: hidden;">
      <div class="image-block" style="display: flex; width: 100%;">
        ...
        <img src="{{ asset('gim_1_2.png') }}" style="min-width: 100%; transition: transform 0.5s ease;">
        <img src="{{ asset('gim_1_3.png') }}" style="min-width: 100%; transition: transform 0.5s ease;">
        <img src="{{ asset('gim_1_4.png') }}" style="min-width: 100%; transition: transform 0.5s ease;">
        <img src="{{ asset('gim_1_5.png') }}" style="min-width: 100%; transition: transform 0.5s ease;">
        <img src="{{ asset('gim_1_6.png') }}" style="min-width: 100%; transition: transform 0.5s ease;">
