...
.tab-content.active {
  ...
  <div class="container">
    ...
    <!-- Title -->
    <h2 class="text-center section-title mb-5">Goals And Objectives</h2>
    ...
    <div class="row">
      <div class="col-lg-8 mx-auto">
        <ul class="goals-list">
          <li>The teachings of the Holy Quran and the Sunnah of Allah’s Messenger Muhammad (peace be upon him) are the core principles of As-Sunnah Foundation.</li>
          <li>The teachings of the Holy Quran and the Sunnah of Allah’s Messenger Muhammad (peace be upon him) are the core principles of As-Sunnah Foundation.</li>
          <li>The teachings of the Holy Quran and the Sunnah of Allah’s Messenger Muhammad (peace be upon him) are the core principles of As-Sunnah Foundation.</li>
          <li>The teachings of the Holy Quran and the Sunnah of Allah’s Messenger Muhammad (peace be upon him) are the core principles of As-Sunnah Foundation.</li>
          <li>The teachings of the Holy Quran and the Sunnah of Allah’s Messenger Muhammad (peace be upon him) are the core principles of As-Sunnah Foundation.</li>
...
<section class="goals-section py-5">
  <div class="container">
    ...
    <!-- Tabs -->
    <div class="d-flex justify-content-center gap-5 mb-4 goals-tabs">
      <div class="tab-item active" data-tab="education">
        🎓 Education
      </div>
      <div class="tab-item" data-tab="dawah">
        🤲 Dawah
      </div>
    ...
    <div class="row">
      <div class="col-lg-8 mx-auto">
        ...
        <div class="tab-content active" id="education">
          <ul class="goals-list">
            <li>The teachings of the Holy Quran and the Sunnah are the core principles of education.</li>
            <li>Promoting Islamic knowledge through structured learning.</li>
            <li>Developing morally upright students.</li>
          </ul>
        </div>

        <!-- Dawah -->
        <div class="tab-content" id="dawah">
          <ul class="goals-list">
            <li>Spreading authentic Islamic teachings worldwide.</li>
            <li>Organizing Dawah programs and seminars.</li>
            <li>Using digital platforms for Dawah.</li>
          </ul>
        </div>
        ...
        <div class="tab-content" id="service">
          <ul class="goals-list">
            <li>Serving humanity without discrimination.</li>
            <li>Providing relief during disasters.</li>
