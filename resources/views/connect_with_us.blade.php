...
<body>
    ...
    <style>
        ...
        .hero {
            height: 450px;
            background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('{{ asset('connect_with_us_image.jpg') }}') no-repeat center center;
    ...
    <div>
        <div class="container" style="text-align: center;margin-top: 50px;margin-bottom: 50px;">
            <h2 style="color: black;">You can join us in various ways</h2>
            <p style="color: black;">If you wish to be a part of the welfare activities of As-Sunnah Foundation, you may
                join us through any of the following options. Click on the option that suits your interest.</p>
        </div>
    </div>
    ...
    <div class="container my-4">
        <div class="donor-tabs d-flex justify-content-between align-items-center">

            <div class="donor-tab active" data-tab="regular">
                <i class="fa-solid fa-hand-holding-heart"></i>
                <span>Regular Donor</span>
            </div>

            <div class="donor-tab" data-tab="lifetime">
                <i class="fa-solid fa-gift"></i>
                <span>Lifetime & Donor Member</span>
            </div>

            <div class="donor-tab" data-tab="volunteer">
                <i class="fa-solid fa-people-group"></i>
                <span>Volunteer</span>
            </div>

            <div class="donor-tab" data-tab="career">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="text-section">
                                                    ...
                                                    <ul class="text-list">
                                                        <li>eiusmod tempor incididunt ut labore et dolore magna aliqua.
                                                        </li>
                                                        <li>eiusmod tempor incididunt ut labore et dolore magna aliqua.
                                                        </li>
                                                        <li>eiusmod tempor incididunt ut labore et dolore magna aliqua.
...
">
                                            ...
                                            <p class="text-muted textleft">Lorem ipsum dolor sit amet, consectetur
                                                adipiscing elit.
                                                Sed do
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form action="#" method="POST">
                                                <div class="form-group mb-3">
                                                    <label for="donationAmount" class="textleft">Bkash/Nagad Merchant:
                                                        01000000000
                                                    ...
                                                    <div class="form-group mb-3 textleft">
                                                        <label for="name" class="textleft mb-2 mt-2">Enter
                                                            Amount</label>
                                                    ...
                                                    <div class="form-group mb-3 textleft">
                                                        <label for="phoneEmail" class="textleft mb-2">Phone /
                                                            Email</label>
                                                        <input type="text" class="form-control" id="phoneEmail"
                                                            name="phoneEmail"
                                                            placeholder="Enter your phone number or email" required>
                                                    </div>

                                                    <div class="form-group mb-3 textleft">
                                                        <label for="donateOnBehalf" class="textleft mb-2">Donate on
                                                            behalf
                                                            of</label>
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio"
                                                                name="paymentMethod" id="bkash" value="bkash">
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio"
                                                                name="paymentMethod" id="nagad" value="nagad">
                                                    ...
                                                    <div class="form-group mb-3">
                                                        <p class="text-center text-muted">You will receive tax relief
                                                            when you
                                                            donate to
                                                    ...
                                                    <div class="form-group text-center">
                                                        <button type="submit"
                                                            class="btn btn-warning btn-lg">Donate</button>
                                                    </div>
                                            </form>
                                        </div>
                                            ...
                                            <div class="card shadow-sm">
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center">
                                                        <img src="bank-logo.png" alt="Bank Logo" class="me-3"
                                                            style="width: 50px;">
                                                        <div>
                                                            <h5 class="mb-0">Bank: <span class="fw-normal">Islami Bank
                                                                    PLC</span>
                                                            </h5>
                                                            <p class="mb-0">Account Name: <span class="fw-normal">Let’s
                                                                    Go-on
                                                                    Foundation</span></p>
                                                            <p class="mb-0">Branch: <span class="fw-normal">Dhanmondi,
                                                                    Dhaka</span>
                                                            </p>
                                                            <p class="mb-0">Account No: <span
                                                                    class="fw-normal">09876543215679987</span></p>
                                                            <p class="mb-0">Routing No: <span
                                                                    class="fw-normal">1234567</span></p>
                                                            <p class="mb-0">Swift Code: <span
                                                                    class="fw-normal">XYZ</span></p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <div class="tab-pane" id="lifetime">
                <h5>Lifetime & Donor Member</h5>
                <p>Content for lifetime members goes here.</p>
            </div>

            <div class="tab-pane" id="volunteer">
                <h5>Volunteer</h5>
                <p>Volunteer-related content goes here.</p>
            </div>

            <div class="tab-pane" id="career">
                <h5>Career</h5>
                <p>Career opportunities content goes here.</p>
            </div>
        </div>
    </div>
            ...
            <div class="registration-card mx-auto">
                ...
                <form>
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label class="form-label">Profession Selected</label>
                        ...
                        <div class="col-md-6">
                            <label class="form-label">Special Skill</label>
                            <input type="text" class="form-control">
                        </div>
                        ...
                        <div class="col-md-6">
                            <label class="form-label">Permanent District/Upazila</label>
                            <input type="text" class="form-control">
                        </div>

                        <div class="col-md-6">
                            <label class="form-label">Permanent District/Upazila Selected</label>
                            <select class="form-select">
                                <option selected>Select</option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-6">
                            <label class="form-label">Permanent Address Details</label>
                            <input type="text" class="form-control">
                        </div>
                        ...
                        <div class="col-md-6">
                            <label class="form-label">Present District/Upazila</label>
                            <input type="text" class="form-control">
                        </div>

                        <div class="col-md-6">
                            <label class="form-label">Present District/Upazila Selected</label>
                            <select class="form-select">
                                <option selected>Select</option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-6">
                            <label class="form-label">Present Address Details</label>
                            <input type="text" class="form-control">
                        </div>
...
<script>
    $(document).ready(function () {
        $('.donor-tab').on('click', function () {
            const tab = $(this).data('tab');

            $('.donor-tab').removeClass('active');
