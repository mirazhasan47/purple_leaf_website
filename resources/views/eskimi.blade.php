...
<head>
  ...
  <style>
    * {
    ...
    .headerr {
      background: url('{{ asset('eskimi_hero.png') }}') no-repeat center center;
      background-size: cover;
      text-align: center;
      padding: 60px 20px;
      height: 611px;
    ...
    @media (max-width: 768px) {
      .headerr {
        background: url('{{ asset('eskimi_mb.png') }}') no-repeat center center;
        background-size: cover;
        height: auto;
    ...
    <div class="row text-center">
      ...
      <div class="col-md-4 mb-4">
        <div class="d-flex justify-content-center gap-2">
          ...
          <span class="mont_regular_three_sixteen">Eskimi</span>
        </div>
      </div>
      ...
      <div class="col-md-4 mb-4">
        <div class="d-flex justify-content-center gap-2">
          ...
          <span class="mont_regular_three_sixteen">AdTech</span>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="columns">
      <div class="column text-left">
        ...
        <p class="karla_regular_three_sixteen">The problem is that companies struggle to create effective digital
          advertising campaigns that drive real business results due to audience targeting, campaign measurement, and
          optimization challenges.</p>
      </div>
      <div class="column text-left">
        <h3 class="mont_bold_six_twenty_four">Context</h3>
        <p class="karla_regular_three_sixteen">Eskimi is an AdTech platform that helps brands and agencies to conduct
          programmatic advertising campaigns and target unique audiences using engaging custom-rich media creatives and
          advanced targeting.</p>
      </div>
    </div>
  </section>
          ...
          <div class="card-body">
            <ul class="list-unstyled pain-point-list">
              <li class="d-flex align-items-start mb-3">
                ...
                <span>Increase brand awareness and reach the target audience.</span>
              </li>

              <li class="d-flex align-items-start mb-3">
                <span class="icon">👉</span>
                <span>Improve ROI and return on ad spend.</span>
              </li>

              <li class="d-flex align-items-start mb-3">
                <span class="icon">👉</span>
                <span>Build customer engagement and loyalty.</span>
              </li>
              ...
              <li class="d-flex align-items-start">
                <span class="icon">👉</span>
                <span>
                  Track and measure campaign success using
  ...
  <section class="info" style="    width: 85%;
    ...
    <div class="columns">
      <div class="column text-left">
        ...
        <div class="subheader">
          <p class="mont_regular_three_sixteen" style="font-size: 20px;">According to our research</p>
        </div>
      </div>
      <div class="column text-left">
        <div class="">
          <div class="card-body">
            <ul class="list-unstyled pain-point-list">
              <li class="d-flex align-items-start mb-3">
                <span class="icon">👉</span>
                <span>Hard to design unique and engaging social banners on your own.</span>
              </li>

              <li class="d-flex align-items-start mb-3">
                <span class="icon">👉</span>
                <span>Don’t know how to reach global audience.</span>
              </li>

              <li class="d-flex align-items-start mb-3">
                <span class="icon">👉</span>
                <span>Doesn’t have proper knowledge of digital marketing.</span>
              </li>

              <li class="d-flex align-items-start">
                <span class="icon">👉</span>
                <span>
                  Don't know how to stand out from the competition.
                </span>
              </li>
              ...
              <li class="d-flex align-items-start">
                <span class="icon">👉</span>
                <span>
                  Doesn’t know how to find the target audiences in the digital world.
                </span>
              </li>
            </ul>
  ...
  <section class="design-solution" style="width: 50%; margin: 0 auto; margin-bottom: 50px;">
    <div class="center" style="overflow: hidden;">
      <div class="image-block" style="display: flex; width: 100%;">
        ...
        <img src="{{ asset('eskimi_1_2.png') }}" style="min-width: 100%; transition: transform 0.5s ease;">
        <img src="{{ asset('eskimi_1_3.png') }}" style="min-width: 100%; transition: transform 0.5s ease;">
        <img src="{{ asset('eskimi_1_4.png') }}" style="min-width: 100%; transition: transform 0.5s ease;">
