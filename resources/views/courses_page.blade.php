...
<body>
    ...
    <section class="py-5 bg-light">
        <div class="container">
            <div class="row g-4 align-items-start">
                ...
                <!-- Goals -->
                <div class="col-lg-6">
                    <h4 class="mb-3">Project Goals & Objectives</h4>
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item"><i class="bi bi-check-circle text-warning me-2"></i>Skill
                            Enhancement</li>
                        <li class="list-group-item"><i class="bi bi-check-circle text-warning me-2"></i>Employment
                            Opportunities</li>
                        <li class="list-group-item"><i class="bi bi-check-circle text-warning me-2"></i>Community
                            Development</li>
                        <li class="list-group-item"><i class="bi bi-check-circle text-warning me-2"></i>Sustainable
                            Income</li>
                    </ul>
                </div>
    ...
    <section class="py-4 bg-warning-subtle">
        <div class="container d-flex flex-column flex-md-row justify-content-between align-items-center">
            ...
            <a href="#" class="btn btn-warning px-4">Donate</a>
        </div>
    </section>
    ...
    <section class="py-5">
        <div class="container">
            <h3 class="text-center mb-4">Course Description</h3>
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card h-100 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <a href="#" class="btn btn-outline-warning btn-sm">See Details</a>
                        </div>
                    </div>
                </div>
    ...
    <section class="py-5 bg-light">
        <div class="container">
            ...
            <img src="https://via.placeholder.com/1200x500" class="img-fluid rounded shadow mb-3">

            <div class="row g-3">
                <div class="col-3"><img src="https://via.placeholder.com/300" class="img-fluid rounded"></div>
                <div class="col-3"><img src="https://via.placeholder.com/300" class="img-fluid rounded"></div>
                <div class="col-3"><img src="https://via.placeholder.com/300" class="img-fluid rounded"></div>
                <div class="col-3"><img src="https://via.placeholder.com/300" class="img-fluid rounded"></div>
            </div>
    ...
    <section class="py-5">
  <div class="container">
    <h3 class="text-center mb-4">Impact Statistics</h3>
    ...
    <div class="row g-4 justify-content-center">
      ...
      <div class="col-6 col-md-3">
        <div class="text-center p-4 border rounded bg-white shadow-sm">
          ...
          <p class="mt-2 fw-semibold">Electrical Training</p>
        </div>
      </div>
    </div>
  </div>
