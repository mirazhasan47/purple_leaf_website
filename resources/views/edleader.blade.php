...
<head>
  ...
  <style>
    * {
    ...
    @media (max-width: 768px) {
      .headerr {
        background: url('{{ asset('edleader_mb.png') }}') no-repeat center center;
        background-size: cover;
        height: auto;
        height: 210px;
        margin-top: 50px;
...
<body>
    ...
    <div class="row text-center">
      ...
      <div class="col-md-4 mb-4">
        <div class="d-flex justify-content-center gap-2">
          ...
          <span class="mont_regular_three_sixteen">EdLeader 21</span>
        </div>
      </div>
      ...
      <div class="col-md-4 mb-4">
        <div class="d-flex justify-content-center gap-2">
          ...
          <span class="mont_regular_three_sixteen">Web App</span>
        </div>
      </div>
      ...
      <div class="col-md-4 mb-4">
        <div class="d-flex justify-content-center gap-2">
          ...
          <span class="mont_regular_three_sixteen">Education</span>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="info" style="    width: 85%;
    ...
    <div class="columns">
      ...
      <div class="column text-left">
        <p class="karla_regular_three_sixteen">In order to gain a deeper understanding of our client’s problem and close
          the knowledge gap regarding its stakeholders and broader product strategy we conducted interviews with
          superintendents, educators & leaders. Based on the insights we found, we prepared user personas and a user
          journey map.</p>
      </div>
    </div>
  </section>
  ...
  <section class="interview-results" style="width: 50%;
    ...
    <div class="center">
      <div class="image-block">
        <img src="{{ asset('edleader_image_3.png') }}" alt="Survey Results" class="img-fluid" />
      </div>
    </div>
  </section>
  ...
  <section class="personas" style="width: 50%;
    ...
    <div class="center">
      <div class="image-block">
        <img src="{{ asset('edleader_image_4.png') }}" alt="User Persona" class="img-fluid" />
      </div>
    </div>
  </section>
  ...
  <section class="journey-map" style="width: 50%;
    ...
    <div class="center">
      <div class="image-block">
        <img src="{{ asset('edleader_image_5.png') }}" alt="User Journey Map" class="img-fluid" />
      </div>
    </div>
  </section>
  ...
  <section class="design-solution" style="width: 50%; margin: 0 auto; margin-bottom: 50px;">
    <div class="center" style="overflow: hidden;">
      <div class="image-block" style="display: flex; width: 100%;">
        ...
        <img src="{{ asset('edleader_1_2.png') }}" style="min-width: 100%; transition: transform 0.5s ease;">
        <img src="{{ asset('edleader_1_3.png') }}" style="min-width: 100%; transition: transform 0.5s ease;">
        <img src="{{ asset('edleader_1_4.png') }}" style="min-width: 100%; transition: transform 0.5s ease;">
