...
<head>
  ...
  <style>
    * {
    ...
    .headerr {
      background: url('{{ asset('london_hero.png') }}') no-repeat center center;
      background-size: cover;
      text-align: center;
      padding: 60px 20px;
      height: 611px;
    ...
    @media (max-width: 768px) {
      .headerr {
        background: url('{{ asset('london_mb.png') }}') no-repeat center center;
        background-size: cover;
        height: auto;
  ...
  <section class="design-solution" style="width: 50%; margin: 0 auto; margin-bottom: 50px;">
    <div class="center" style="overflow: hidden;">
      <div class="image-block" style="display: flex; width: 100%;">
        ...
        <img src="{{ asset('london_1_2.png') }}" style="min-width: 100%; transition: transform 0.5s ease;">
        <img src="{{ asset('london_1_3.png') }}" style="min-width: 100%; transition: transform 0.5s ease;">
        <img src="{{ asset('london_1_4.png') }}" style="min-width: 100%; transition: transform 0.5s ease;">
        <img src="{{ asset('london_1_5.png') }}" style="min-width: 100%; transition: transform 0.5s ease;">
        <img src="{{ asset('london_1_6.png') }}" style="min-width: 100%; transition: transform 0.5s ease;">
        <img src="{{ asset('london_1_7.png') }}" style="min-width: 100%; transition: transform 0.5s ease;">
        <img src="{{ asset('london_1_8.png') }}" style="min-width: 100%; transition: transform 0.5s ease;">
        <img src="{{ asset('london_1_9.png') }}" style="min-width: 100%; transition: transform 0.5s ease;">
      </div>
    </div>
