...
.hero {
    height: 450px;
    background: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('{{ asset('lets_make_change_together.jpg') }}') no-repeat center center;
...
<div class="hero">
  <div class="container" style="text-align: center;">
      <h4 style="color: white;">Let's make change together</h4>
  </div>
</div>
