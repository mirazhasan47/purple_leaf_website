...
.hero {
    height: 80.85vh;
    background: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('{{ asset('blogsbg.jpg') }}') no-repeat center center;
...
<div class="container donation-container">
    <form>
        <div class="form-row">
            <div class="form-group position-relative">
                <input type="text" class="form-control ps-5" id="blogSearch" placeholder="Search blogs...">
  ...
  <div class="container my-5" style="margin-bottom: 200px!important;">
    <div class="row align-items-center shadow rounded overflow-hidden">
      
      <!-- Left Image -->
      <div class="col-md-6 p-0">
        <img src="{{ asset('ongoing_one.png') }}" alt="Children in classroom" class="img-fluid w-100 h-100 object-cover">
      </div>
      
      <!-- Right Text -->
      <div class="col-md-6 p-4 bg-light">
        <h5 class="fw-bold text-dark mb-3">Lorem ipsum dolor sit amet, consec adipiscing elit,</h5>
  ...
  <div class="row">
    <div class="col-md-4">
      <div class="card">
        ...
        <div class="card-body">
          <p class="card-text fw-bold">Lorem ipsum dolor.</p>
          <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
          <p class="card-text">29 january 2025</p>
        </div>
      </div>
    </div>
