...
<head>
    ...
    <style>
       ...
       but `row-cols-1` handles this well, so mainly focus on spacing */
        ...
        .headerr {
            background: url('{{ asset('karighor_hero.png') }}') no-repeat center center;
            background-size: cover;
            text-align: center;
            padding: 60px 20px;
            height: 611px;
        ...
        @media (max-width: 768px) {
            .headerr {
                background: url('{{ asset('karighor_mb.png') }}') no-repeat center center;
                background-size: cover;
                height: auto;
...
<body>
        ...
        <div class="row text-center">
            ...
            <div class="col-md-4 mb-4">
                <div class="d-flex justify-content-center gap-2">
                    ...
                    <span class="mont_regular_three_sixteen">Website, Mobile App</span>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="d-flex justify-content-center gap-2">
                    ...
                    <span class="mont_regular_three_sixteen">Creative Industry</span>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="columns">
            <div class="column text-left">
                ...
                <p class="karla_regular_three_sixteen">Poverty is forcing many artistes, craftsmen and others in
                    Bangladesh to give up long-practised heritage crafted products of embroidery, weaving, dyeing skills
                    that they had learnt from their ancestors.
                    Many of these artistes and artisans do not even want that their children to follow them taking up
                    these heritage crafts as their professions.
                </p>
            </div>
            <div class="column text-left">
                <h3 class="mont_bold_six_twenty_four">About</h3>
                <p class="karla_regular_three_sixteen">KARIGHOR is a platform for artisans in Bangladesh to digitse
                    thier heritage crafting processes and display thier work to the world.
                    It encourages an exchange of practice and knowledge, an open source working methods and collective
                    forms of organising.
                </p>
            </div>
        </div>
    ...
    margin: 0 auto;">
        <div class="columns">
            <div class="column text-left">
                <div class="header">
                    <h3 class="mont_bold_six_twenty_four">Objectives</h3>
                </div>
            </div>
            <div class="column text-left">
                <div class="">
                    <div class="card-body">
                        <ul class="list-unstyled pain-point-list">
                            <li class="d-flex align-items-start mb-3">
                                ...
                                <span>Build an online archive of making Bangladeshi endangered craft work. </span>
                            </li>

                            <li class="d-flex align-items-start mb-3">
                                <span class="icon">👉</span>
                                <span>Help artisans showcase thier unique work process.</span>
                            </li>

                            <li class="d-flex align-items-start mb-3">
                                <span class="icon">👉</span>
                                <span>Digitise heritage craft processes.</span>
                            </li>
                        </ul>
    ...
    <section class="design-solution" style="width: 50%; margin: 0 auto; margin-bottom: 50px;">
        <div class="center" style="overflow: hidden;">
            <div class="image-block" style="display: flex; width: 100%;">
                ...
                <img src="{{ asset('karighor_2_2.png') }}" style="min-width: 100%; transition: transform 0.5s ease;">
                <img src="{{ asset('karighor_2_3.png') }}" style="min-width: 100%; transition: transform 0.5s ease;">
            </div>
        </div>
    ...
    <section class="design-solution" style="width: 50%; margin: 0 auto; margin-bottom: 50px;">
        <div class="center" style="overflow: hidden;">
            <div class="image-block" style="display: flex; width: 100%;">
                ...
                <img src="{{ asset('karighor_1_2.png') }}" style="min-width: 100%; transition: transform 0.5s ease;">
                <img src="{{ asset('karighor_1_3.png') }}" style="min-width: 100%; transition: transform 0.5s ease;">
                <img src="{{ asset('karighor_1_4.png') }}" style="min-width: 100%; transition: transform 0.5s ease;">
                <img src="{{ asset('karighor_1_5.png') }}" style="min-width: 100%; transition: transform 0.5s ease;">
                <img src="{{ asset('karighor_1_6.png') }}" style="min-width: 100%; transition: transform 0.5s ease;">
                <img src="{{ asset('karighor_1_7.png') }}" style="min-width: 100%; transition: transform 0.5s ease;">
            </div>
        </div>
        <div class="number-nav" style="text-align: center; margin-top: 15px; font-family: sans-serif;"></div>
    </section>
