    ...
    <div class="container-fluid d-flex align-items-center justify-content-center min-vh-100">
        <div class="row justify-content-center w-100">
            <div class="col-lg-8 col-md-8 col-12 d-flex justify-content-center align-items-center">
                <div class="login-box d-flex align-items-center justify-content-between">
                    <!-- Left side: Image and Laptop Icon -->
                    <div class="image-container">
                        <img src="{{ asset('login-left-bg.png') }}" alt="Laptop Image" class="img-fluid laptop-img">
                    </div>
                    ...
                    <div class="form-container">
                        ...
                        <form>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="email" placeholder="Type mobile/email" required>
                            </div>
                            <button type="submit" class="btn btn-primary btn-block animate-arrow">
