...
<head>
  ...
  <style>
    * {
    ...
    .hero {
      min-height: 100vh;
      background: url('{{ asset("flexi_hero.png") }}') no-repeat center center;
    ...
    .headerr {
      background: url('{{ asset('flexinote_hero.png') }}') no-repeat center center;
      background-size: cover;
      text-align: center;
      padding: 60px 20px;
      height: 611px;
...
<body>
    ...
    <div class="columns">
      <div class="column text-left">
        ...
        <p class="karla_regular_three_sixteen">So many people struggle to keep track of their tasks and to manage their
          time effectively. They are overwhelmed with a long to-do list and often forget important tasks. The goal of
          this app is to help users prioritize their tasks, set deadlines, and manage their workload efficiently.</p>
      </div>
      <div class="column text-left">
        <h3 class="mont_bold_six_twenty_four">Overview</h3>
        <p class="karla_regular_three_sixteen">Flexi Note is a task management app designed to help people stay
          organized and productive. Create tasks, set due dates, and categorize them based on groups or sub-groups.
          Access your tasks from anywhere, at any time. ”X” is available on both web and mobile platforms.</p>
      </div>
    </div>
  </section>
          ...
          <div class="card-body">
            <ul class="list-unstyled pain-point-list">
              <li class="d-flex align-items-start mb-3">
                ...
                <span>Help users organize and prioritize their tasks. </span>
              </li>

              <li class="d-flex align-items-start mb-3">
                <span class="icon">👉</span>
                <span>Increase productivity by providing users with a streamlined way to manage their tasks,</span>
              </li>

              <li class="d-flex align-items-start mb-3">
                <span class="icon">👉</span>
                <span>Reduce stress and overwhelm: By providing a clear and organized way to manage tasks.</span>
              </li>
            </ul>
    ...
    <div class="columns">
      ...
      <div class="column text-left">
        <div class="">
          <div class="card-body">
            <P>
              Interviews were conducted with students, researchers, corporate executives etc to gain deeper insights
              into their pain points while doing task management. The interviews were conducted one-on-one and lasted
              approximately 30-45 minutes each. The following topics were covered in the interviews:
            </P>
          </div>
        </div>
  ...
  <section class="interview-results" style="width: 50%;
    ...
    <div class="center">
      <div class="image-block">
        <img src="{{ asset('flexOne.png') }}" alt="Survey Results" class="img-fluid" />
      </div>
    </div>
  </section>
  ...
  <section class="info" style="    width: 85%;
    ...
    <div class="columns">
      <div class="column text-left">
        ...
        <div class="subheader">
          <p class="mont_regular_three_sixteen" style="font-size: 20px;">from data</p>
        </div>
      </div>
      <div class="column text-left">
        <div class="">
          <div class="card-body">
            <ul class="list-unstyled pain-point-list">
              <li class="d-flex align-items-start mb-3">
                <span class="icon">👉</span>
                <span>Many users prioritize their tasks based on deadlines or urgency, but struggle to balance competing
                  priorities. </span>
              </li>

              <li class="d-flex align-items-start mb-3">
                <span class="icon">👉</span>
                <span>Users prefer task management apps that allow them to categorize tasks based on projects or
                  subjects, as this helps with organization and prioritization.</span>
              </li>

              <li class="d-flex align-items-start mb-3">
                <span class="icon">👉</span>
                <span>Reminders are important to users, but they prefer to be able to customize the timing and frequency
                  of reminders.</span>
              </li>
              <li class="d-flex align-items-start mb-3">
                <span class="icon">👉</span>
                <span>Users struggle with keeping track of all their tasks and tend to feel overwhelmed.</span>
              </li>
            </ul>
  ...
  <section class="personas" style="width: 50%;
    ...
    <div class="center">
      <div class="image-block">
        <img src="{{ asset('flexTwo.png') }}" alt="User Persona" class="img-fluid" />
      </div>
    </div>
  </section>
  ...
  <section class="personas" style="width: 50%;
    ...
    <div class="center">
      <div class="image-block">
        <img src="{{ asset('flexThree.png') }}" alt="User Persona" class="img-fluid" />
      </div>
    </div>
  </section>
    ...
    <section class="design-solution" style="width: 50%; margin: 0 auto; margin-bottom: 50px;">
        <div class="center" style="overflow: hidden;">
            <div class="image-block" style="display: flex; width: 100%;">
                ...
                <img src="{{ asset('flexi_1_2.png') }}" style="min-width: 100%; transition: transform 0.5s ease;">
                <img src="{{ asset('flexi_1_3.png') }}" style="min-width: 100%; transition: transform 0.5s ease;">
            </div>
        </div>
    ...
    <section class="design-solution" style="width: 50%; margin: 0 auto; margin-bottom: 50px;">
        <div class="center" style="overflow: hidden;">
            <div class="image-block" style="display: flex; width: 100%;">
                ...
                <img src="{{ asset('flexi_2_2.png') }}" style="min-width: 100%; transition: transform 0.5s ease;">
                <img src="{{ asset('flexi_2_3.png') }}" style="min-width: 100%; transition: transform 0.5s ease;">
            </div>
        </div>
        <div class="number-nav" style="text-align: center; margin-top: 15px; font-family: sans-serif;"></div>
    </section>
