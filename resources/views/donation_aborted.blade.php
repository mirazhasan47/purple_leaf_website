...
<body>
    ...
    <style>
        ...
        .btn-primary {
            background-color: #FE6F0F!important;
            border-color: #FE6F0F;
            color: white;
            font-weight: bold;
...
.animate-arrow .arrow {
  ...
  font-size: 30px;
  line-height: 1;   /* Removes vertical padding look */
  margin-left: 4px; /* Optional: tiny spacing */
}
...
.animate-arrow:hover .arrow {
  ...
  <div class="container text-center" style="    background-color: #f9f5e1;
    margin-top: 176px;margin-bottom: 50px;">
    <div class="row">
      <div class="col-12">
        <p class="error-title" style="
    margin-top: 76px;">Sorry!</p>
        <h4 class="message" >Donation Aborted</h4>
        <p>Your donation transaction has been cancelled.</p>
        <button class="retry-btn" onclick="window.location.reload();">Retry</button>
        <h2 class="message">What you need to do</h2>
        <div class="instructions">
          <p><i class="bi bi-check-circle"></i> Please check your card information again.</p>
          <p><i class="bi bi-check-circle"></i> Check your internet connection.</p>
          <p><i class="bi bi-check-circle"></i> If the problem is not resolved, contact us.</p>
        </div>
        <h2 class="message">Contact Us</h2>
        <div class="contact-info">
          <p><i class="bi bi-telephone"></i> Phone: 01767404822</p>
          <p><i class="bi bi-envelope"></i> Email: info.lgf.hq@gmail.com</p>
        </div>
      </div>
    </div>
  </div>
